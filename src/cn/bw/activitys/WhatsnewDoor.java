...
public class WhatsnewDoor extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		ScaleAnimation myscaleanim = new ScaleAnimation(1f,3f,1f,3f,Animation.RELATIVE_TO_SELF,0.5f,Animation.RELATIVE_TO_SELF,0.5f);//缩放
		myscaleanim.setDuration(1000);
		AlphaAnimation myalphaanim = new AlphaAnimation(1,0.0001f);//渐渐模糊
		...
		new Handler().postDelayed(new Runnable(){
			@Override
			public void run(){
				Intent intent = new Intent (WhatsnewDoor.this,MainWeixinActivity.class);			
